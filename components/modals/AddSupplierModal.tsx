...
const AddSupplierModal: React.FC<AddSupplierModalProps> = ({ isOpen, onClose, onSelect, title }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50" onClick={onClose}>
      <div className="relative bg-gray-800 rounded-xl shadow-2xl p-6 w-full max-w-lg mx-4 flex flex-col border-t-4 border-blue-500" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="relative">
            ...
            <input
                ...
                autoFocus
                className="w-full bg-gray-900 border border-gray-700 text-gray-200 rounded-md p-3 pl-10 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
            />
        </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    {filteredSuppliers.map(supplier => (
                        <button 
                            ...
                            className="flex items-center justify-center text-center p-3 bg-gray-700/60 rounded-lg hover:bg-indigo-600 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-indigo-500 h-24"
                        >
