        ...
        <div className="mt-6 border-t border-gray-700 pt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            <div>
              ...
              <input id="alias-from" type="text" value={newAliasFrom} onChange={(e) => setNewAliasFrom(e.target.value)} className="w-full bg-gray-700 text-gray-200 rounded-md p-2 outline-none text-sm"/>
            </div>
             <div>
              <label htmlFor="alias-to" className="block text-xs text-gray-400 mb-1">To (Database Item Name)</label>
              <input id="alias-to" type="text" value={newAliasTo} onChange={(e) => setNewAliasTo(e.target.value)} className="w-full bg-gray-700 text-gray-200 rounded-md p-2 outline-none text-sm" />
            </div>
          </div>
          <div className="mt-4 flex justify-between items-center">
                <div className="flex items-center">
                    <input id="is-global-rule" type="checkbox" checked={isGlobal} onChange={(e) => setIsGlobal(e.target.checked)} className="h-4 w-4 rounded bg-gray-900 border-gray-600 text-indigo-600 focus:ring-0" />
